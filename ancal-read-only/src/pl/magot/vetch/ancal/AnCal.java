...
public class AnCal extends CommonActivity
{
  ...
  private void InitViews()
  {
   ...
   //localize TimeWidget
   DurationWidget.setStrings(utils.GetResStr(R.string.strDurationWidgetSelect),
  			utils.GetResStr(R.string.strDurationWidgetNone),
  			utils.GetResStr(R.string.strDurationWidgetSet));
