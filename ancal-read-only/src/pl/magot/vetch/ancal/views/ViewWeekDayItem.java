...
public class ViewWeekDayItem extends View
{
  ...
  private boolean bHoliday = false;
	...
	public void AddTimeItem(int iHour, int iMinute, int iDurationInMinutes, boolean allday, boolean alarm, String subject)
	{
	...
	private void drawHourItems(Canvas canvas, boolean bFocused)
	{
		...
		//outer frame
			if (item.alarm) {
 			...
 			mpt.setColor(dayStyle.iColorFrame);
 			mpt.setAntiAlias(true);
 			canvas.drawText(item.subject, rectDayView.left + 3,iTimeItemTop + 12 , mpt);
